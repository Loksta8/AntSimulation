...
1.  **Install Prerequisites ✅**:
    ...
    * **Dependencies (OpenSSL & SFML System Libraries)**:
        ...
        **Fedora:**
            ```bash
            sudo dnf install mesa-libGL-devel libXrandr-devel libXcursor-devel systemd-devel openal-soft-devel libflac-devel libvorbis-devel freetype-devel openssl-devel
            ```
        **Arch Linux:**
        ```bash
        sudo pacman -Syu glu libxrandr libxcursor systemd openal flac libvorbis freetype2 openssl
        ```
